...
class ElectricianServiceAdapter(private val services: List<ElectricianService>) :
    RecyclerView.Adapter<ElectricianServiceAdapter.ElectricianServiceViewHolder>() {

    class ElectricianServiceViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ElectricianServiceViewHolder {
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_electrician_service, parent, false)
        return ElectricianServiceViewHolder(itemView)
    }

    override fun onBindViewHolder(holder: ElectricianServiceViewHolder, position: Int) {
