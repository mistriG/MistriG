...
class LaundryServiceAdapter(private val services: List<LaundryService>) :
    RecyclerView.Adapter<LaundryServiceAdapter.LaundryServiceViewHolder>() {

    class LaundryServiceViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LaundryServiceViewHolder {
        ...
        return LaundryServiceViewHolder(itemView)
    }
